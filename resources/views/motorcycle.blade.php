         ...
         <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div class="card w-84 glass bg-gray-300 shadow-xl bg-gradient-to-b">
                    <figure class="px-10 pt-10"><img src="{{asset('images/pcx.png') }}" class="mb-4"/></figure>
                ...
                <div class="card w-84 glass bg-gray-300 shadow-xl bg-gradient-to-b">
                    <figure class="px-10 pt-10"><img src="{{asset('images/beatstreet.png') }}" class="mb-4"/></figure>
                    <div class="card-body bg-white items-center text-center">
                ...
                <div class="card w-84 glass bg-gray-300 shadow-xl bg-gradient-to-b">
                    <figure class="px-10 pt-10"><img src="{{asset('images/hondacbr.png') }}" class="mb-4"/></figure>
                    <div class="card-body bg-white items-center text-center">
                ...
                <div class="card w-84 glass bg-gray-300 shadow-xl bg-gradient-to-b">
                    <figure class="px-10 pt-10"><img src="{{asset('images/vario.png') }}" class="mb-4"/></figure>
                    <div class="card-body bg-white items-center text-center">
                ...
                <div class="card w-84 glass bg-gray-300 shadow-xl bg-gradient-to-b">
                    <figure class="px-10 pt-10"><img src="{{asset('images/ST125.png') }}" class="mb-4"/></figure>
                    <div class="card-body bg-white items-center text-center">
                ...
                <div class="card w-84 glass bg-gray-300 shadow-xl bg-gradient-to-b">
                    <figure class="px-10 pt-10"><img src="{{asset('images/ADV.png') }}" class="mb-4"/></figure>
                    <div class="card-body bg-white items-center text-center">
                ...
                <div class="card w-84 glass bg-gray-300 shadow-xl bg-gradient-to-b">
                    <figure class="px-10 pt-10"><img src="{{asset('images/scoppy.png') }}" class="mb-4"/></figure>
                    <div class="card-body bg-white items-center text-center">
                ...
                <div class="card w-84 glass bg-gray-300 shadow-xl bg-gradient-to-b">
                    <figure class="px-10 pt-10"><img src="{{asset('images/genio.png') }}" class="mb-4"/></figure>
                    <div class="card-body bg-white items-center text-center">
