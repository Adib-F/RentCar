    ...
    <div class="text-black shadow-md navbar ">
        <div class="navbar-start ">
            <div class="dropdown">
                ...
                <ul tabindex="0"
                    class="z-20 p-2 mt-3 bg-white shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-54">
            ...
            <ul class="px-2 text-lg menu menu-horizontal">
                <li>
                    <details class="relative">
                        <summary class="ml-20 cursor-pointer">
                        ...
                        <ul class="absolute right-0 p-2 mt-2 bg-white shadow-lg">
                            @auth
                            ...
                            @else
                                <li><a href="{{ route('login') }}"><img src="/images/login.svg" alt="">Login</a></li>
                            @endauth
                        </ul>
                    </details>
                </li>
